...
const StackNavigation = ({navigation}) => {
  ...
  return (
   <Tab.Navigator screenOptions={{tabBarStyle:{height:70},tabBarLabelStyle:{fontSize:14},tabBarActiveTintColor: '#ffcc00'}}>
    ...
    <Tab.Screen name="MoMo" component={MoMoScreen} options={{ headerShown:false, tabBarIcon:(color,size)=>(<Image source={require('../../assets/mom.png')}  style={{ borderRadius: 100, height: 90, width: 90 }}
/>)}}/>
